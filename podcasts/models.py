...
class Show(models.Model):
    ...
    short_name = models.CharField(max_length=25, blank=True, null=True, default=None)
...
class Person(models.Model):
    ...
    twitter = models.CharField(max_length=150, blank=True, null=True)
    tumblr = models.CharField(max_length=150, blank=True, null=True)
    image = models.CharField(max_length=150, default="https://www.merriam-webster.com/assets/mw/images/article/art-wap-article-main/egg-3442-e1f6463624338504cd021bf23aef8441@1x.jpg")
